...
class ec_cart_data{
	...
	function __construct( $ec_cart_id ){
		...
		}else if( get_option( 'ec_option_cart_use_session_support' ) && isset( $_SESSION['ec_cart_data_stored'] ) && $GLOBALS['ec_cart_id'] == $_SESSION['ec_cart_data_stored']->session_id )
	...
	public function restore_session_from_db( ){
		...
		}else if( isset( $_SESSION['ec_cart_data_stored'] ) )
			$this->cart_data = $_SESSION['ec_cart_data_stored'];
		else{
		...
		if( isset( $this->cart_data->estimate_shipping_zip ) && $this->cart_data->estimate_shipping_zip != "" )
		...
		if( isset( $this->cart_data->expedited_shipping ) && $this->cart_data->expedited_shipping != "" )
		...
		if( isset( $this->cart_data->shipping_selector ) && $this->cart_data->shipping_selector != "" )
		...
		if( isset( $this->cart_data->email ) && $this->cart_data->email == "guest" )
