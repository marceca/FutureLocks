<div class="ec_admin_list_line_item_fullwidth ec_admin_demo_data_line">
    ...
    <div class="ec_admin_settings_input ec_admin_settings_live_payment_section">
    	...
    	<?php
			...
			// ============session test =================
			if(!isset($_SESSION['ec_test'])) $_SESSION['ec_test'] = 0;
			$_SESSION['ec_test'] += 1;
			
			if(isset($_SESSION['ec_test'])) {
			?><div class="ec_status_subtitles"><div class="dashicons-before dashicons-yes"></div>Session Test (Refresh Browser): <?php echo $_SESSION['ec_test']; ?></div><?php
			}
			
			// ============session path set =============
			if(session_save_path()) {
				?><div class="ec_status_subtitles"><div class="dashicons-before dashicons-yes"></div>Session Path Set: <?php echo session_save_path(); ?> </div><?php
			} else {
				?><div class="ec_status_subtitles"><div class="dashicons-before dashicons-warning"></div>No Session Path Set</div><?php
			}
