...
<section class="ec_cart_page">
    ...
    <div class="ec_cart_right" id="ec_cart_payment_hide_column">
        ...
        <div class="ec_cart_price_row">
            ...
            <div class="ec_cart_price_row_total" id="ec_cart_total"><?php echo $GLOBALS['currency']->get_currency_display( ( ( $product->price + $product->subscription_signup_fee ) * $subscription_quantity ) - $discount_amount ); ?></div>
        </div>
